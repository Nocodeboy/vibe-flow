            ...
            <AnimatePresence mode="popLayout">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className={`absolute top-[-20%] left-[-20%] w-[100vw] h-[100vh] rounded-full blur-[150px] mix-blend-screen opacity-60 ${currentTheme.orb1}`}
                    />

                    {/* Secondary Orb - Counter Flow */}
                    <motion.div
                        animate={{
                            x: ["20%", "-20%", "20%"],
                            y: ["20%", "-20%", "20%"],
