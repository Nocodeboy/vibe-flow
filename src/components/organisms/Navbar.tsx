...
const Navbar: React.FC = () => {
    ...
    return (
        <>
            ...
            {/* Menu overlay content remains exactly the same as before */}
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        initial={{ opacity: 0 }}
                        ...
                        className="fixed inset-0 z-[60] bg-[#050505]/98 backdrop-blur-3xl flex items-center justify-center overflow-hidden"
                    >
